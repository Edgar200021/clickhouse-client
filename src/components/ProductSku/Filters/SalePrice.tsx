...
export const SalePrice = ({ className }: Props) => {
	const minValue = useAppSelector(productSkuSelectors.getFiltersMinSalePrice);
	const minLazyValue = useAppSelector(
		productSkuSelectors.getLazyFiltersMinSalePrice,
	);

	const maxValue = useAppSelector(productSkuSelectors.getFiltersMaxSalePrice);
	const maxLazyValue = useAppSelector(
		productSkuSelectors.getLazyFiltersMaxSalePrice,
	);
